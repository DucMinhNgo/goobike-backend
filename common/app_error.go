...
func NewUpauthorized(root error, msg, log, key string) *AppError {
	return &AppError{
...
func ErrDB(err error) *AppError {
	return NewFullErrorResponse(http.StatusInternalServerError, err, "some whent wrong with DB", err.Error(), "DB_ERROR")
}
...
func CannotCreateEntity(entity string, err error) *AppError {
	return NewCustomError(
		err,
